...
![Thông tin WAF stack](/fcj-workshop-hungdung/images/5-Workshop/hashop-deployment/image8.png)

Đặt stack name là `HaShop-WAF`, sau đó tiếp tục chọn **Next**.

![Đặt tên WAF stack](/fcj-workshop-hungdung/images/5-Workshop/hashop-deployment/image9.png)
...
![Đặt tên foundation stack](/fcj-workshop-hungdung/images/5-Workshop/hashop-deployment/image12.png)
...
![Parameter của foundation stack](/fcj-workshop-hungdung/images/5-Workshop/hashop-deployment/image13.png)
...
![Parameter Lambda và WAF](/fcj-workshop-hungdung/images/5-Workshop/hashop-deployment/image14.png)
...
![Tạo ECS services stack](/fcj-workshop-hungdung/images/5-Workshop/hashop-deployment/image15.png)

Ở phần container image, thay `<ACCOUNT_ID>` bằng AWS account ID thật.

![Parameter container image của ECS](/fcj-workshop-hungdung/images/5-Workshop/hashop-deployment/image16.png)
...
![Đặt tên database initialization stack](/fcj-workshop-hungdung/images/5-Workshop/hashop-deployment/image18.png)

Kiểm tra lại cấu hình stack.

![Review database initialization stack](/fcj-workshop-hungdung/images/5-Workshop/hashop-deployment/image19.png)
