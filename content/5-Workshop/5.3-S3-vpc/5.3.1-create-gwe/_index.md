...
![endpoint](/fcj-workshop-hungdung/images/5-Workshop/5.3-S3-vpc/endpoints.png)

3. In the Create endpoint console:
+ Specify name of the endpoint: ```s3-gwe```
+ In service category, choose **AWS services**

![endpoint](/fcj-workshop-hungdung/images/5-Workshop/5.3-S3-vpc/create-s3-gwe1.png)

+ In **Services**, type ```s3``` in the search box and choose the service with type **gateway**

![endpoint](/fcj-workshop-hungdung/images/5-Workshop/5.3-S3-vpc/services.png)
...
![endpoint](/fcj-workshop-hungdung/images/5-Workshop/5.3-S3-vpc/vpc.png)
...
![endpoint](/fcj-workshop-hungdung/images/5-Workshop/5.3-S3-vpc/policy.png)
...
![endpoint](/fcj-workshop-hungdung/images/5-Workshop/5.3-S3-vpc/complete.png)